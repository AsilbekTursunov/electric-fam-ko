      ...
      <div class="main-table">
        ...
        <el-row class="each-row">
          ...
          <col-el 
            ...
            :lg="{ span: 4 }" 
            :xl="{ span: 3 }"> 
            <CustomInput v-model="applicantInfo.phone" type="phone" />
          </col-el> 
        </el-row>
        <el-row class="each-row">
          <col-el 
      ...
      <div class="main-table">
        <el-row class="each-row">
          ...
          <col-el 
            ...
            <CustomSelect  
              ...
              :data="visitedPlaces"  
            /> 
            <label for="plan-1" class="flex gap-5 align-center">
              <CustomCheck 
                :id="'plan-1'" 
            ...
            <label for="plan-2" class="flex gap-5 align-center">
              <CustomCheck 
                :id="'plan-2'" 
        ...
        <el-row class="each-row">
          ...
          <col-el 
            ...
            :lg="{ span: 20 }"
            :xl="{ span: 21 }">
            <label for="vip" class="flex gap-5 align-center"> 
              <CustomCheck
                :id="'vip'" 
        ...
        <el-row class="each-row">
          ...
          <col-el 
            ...
            <CustomSelect
              ...
              :data="entranceArea"  
            />  
            <label for="laptop" class="flex align-center center gap-5">
              <CustomCheck 
                :id="'laptop'" 
            ...
            <label for="tablet" class="flex align-center center gap-5">
              <CustomCheck 
                :id="'tablet'" 
            ...
            <label for="external-hard" class="flex align-center center gap-5">
              <CustomCheck 
                :id="'external-hard'" 
